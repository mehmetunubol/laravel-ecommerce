...
<ul class="nav sort-source mb-3" data-sort-id="products" data-option-key="filter" data-plugin-options="{'layoutMode': 'fitRows', 'filter': '*'}">
		...
		<h3 class="text-color-default text-2 line-height-1 mb-1"><a href="product.php">Kaldırım Panosu</a></h3>
		<span class="price font-primary text-4"><strong class="text-color-dark">100 TL</strong></span>
		<span class="old-price font-primary text-line-trough text-1"><strong class="text-color-default">150 TL</strong></span>
		</div>
		...
		<span class="image-frame-wrapper image-frame-wrapper-overlay-bottom image-frame-wrapper-overlay-light image-frame-wrapper-align-end">
		<a href="product.php">
		<img src="../../../public/customertemplate/img/demo/product-1.jpg" class="img-fluid" alt="">
		</a>
		<span class="image-frame-action">
		<a href="#" class="btn btn-primary btn-rounded font-weight-semibold btn-v-3 btn-fs-2">SEPETE EKLE</a>
		</span>
		...
		<span class="image-frame-wrapper image-frame-wrapper-overlay-bottom image-frame-wrapper-overlay-light image-frame-wrapper-align-end">
		<a href="product.php">
		<img src="../../../public/customertemplate/img/demo/1.jpg" class="img-fluid" alt="">
		</a>
		<span class="image-frame-action">
		<a href="#" class="btn btn-primary btn-rounded font-weight-semibold btn-v-3 btn-fs-2">SEPETE EKLE</a>
		</span>
		...
		<div class="product-info d-flex flex-column flex-lg-row justify-content-between">
		<div class="product-info-title">
		<h3 class="text-color-default text-2 line-height-1 mb-1"><a href="product.php">T Tipi Dikey Föylük</a></h3>
		<span class="price font-primary text-4"><strong class="text-color-dark">100 TL</strong></span>
		<span class="old-price font-primary text-line-trough text-1"><strong class="text-color-default">150 TL</strong></span>
		</div>
...
<span><i class="fas fa-angle-right" aria-label="Next"></i></span>
		...
		<?php require_once("sections/our_catalogue.php"); ?>
