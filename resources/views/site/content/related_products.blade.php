									...
									<div class="product-info d-flex flex-column flex-lg-row justify-content-between">
										<div class="product-info-title">
											...
											@if(isset($sProduct->sale_price))
												<span class="price font-primary text-4"><strong class="text-color-dark">{{ config('settings.currency_symbol').$sProduct->sale_price }}</strong></span>
												<span class="old-price font-primary text-line-trough text-1"><strong class="text-color-default">{{ config('settings.currency_symbol').$sProduct->price }}</strong></span>
											@else
												<span class="price font-primary text-4"><strong class="text-color-dark">{{ config('settings.currency_symbol').$sProduct->price }}</strong></span>
											@endif
										</div>
