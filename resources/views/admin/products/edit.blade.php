...
@section('styles')
    <link rel="stylesheet" type="text/css" href="{{ asset('admintemplate/js/plugins/dropzone/dist/min/dropzone.min.css') }}"/>
@endsection
@section('content')
    <div class="app-title">
        <div>
...
@push('scripts')
    ...
    <script type="text/javascript" src="{{ asset('admintemplate/js/plugins/dropzone/dist/min/dropzone.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('admintemplate/js/plugins/bootstrap-notify.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('admintemplate/js/app.js') }}"></script>
    <script>
